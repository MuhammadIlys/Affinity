                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex flex-row gap-3">
                                        ...
                                        <div class="d-flex flex-column align-items-center justify-content-center">
                                            <div>
                                                <h6 style="font-size: 30px; font-weight:700" class="text-secondary">{{ $employee->first_name . ' ' . $employee->last_name }}<b></b> </h6>
                                        ...
                                        <div class="card info-card sales-card m-0 p-0">
                                            <div class="card-body p-3 ">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3">
                                                        <h6 style="font-size: 16px; font-weight:600" class="me-2">{{$employee->email}}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card info-card sales-card m-0 p-0">
                                            <div class="card-body p-3 ">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ps-3">
                                                        <h6 style="font-size: 16px; font-weight:600">{{ $employee->phone }}</h6>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
